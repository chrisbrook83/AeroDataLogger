...
namespace ExampleAccelGyroSensor.Sensor
{
    public class MPU6050
    {
        ...
        public void Initialize()
        {
            ...
            ErrorStatus(_I2C.Write(new byte[] { MPU6050_Registers.PWR_MGMT_1, 0xF9 }));
            // FullScaleGyroRange
            ErrorStatus(_I2C.Write(new byte[] { MPU6050_Registers.GYRO_CONFIG, 0xE7 }));
            // FullScaleAccelRange
            ErrorStatus(_I2C.Write(new byte[] { MPU6050_Registers.ACCEL_CONFIG, 0xE7 }));
            // Schlafmodus beenden
            ErrorStatus(_I2C.Write(new byte[] { MPU6050_Registers.PWR_MGMT_1, 0x01 }));
        }
        /// <summary>
